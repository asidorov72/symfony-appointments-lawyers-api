 ...
 */
final class Version20200507190036 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, lawyer_id INT NOT NULL, citizen_id INT NOT NULL, status VARCHAR(50) NOT NULL, meeting_type VARCHAR(100) NOT NULL, meeting_title VARCHAR(100) NOT NULL, meeting_description LONGTEXT DEFAULT NULL, payment_status VARCHAR(50) DEFAULT NULL, duration VARCHAR(50) NOT NULL, datetime DATETIME NOT NULL, date DATETIME NOT NULL, email VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
