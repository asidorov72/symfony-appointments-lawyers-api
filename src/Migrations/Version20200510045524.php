 ...
 */
final class Version20200510045524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, lawyer_id INT NOT NULL, citizen_id INT NOT NULL, status VARCHAR(50) NOT NULL, payment_status VARCHAR(50) DEFAULT NULL, date DATETIME NOT NULL, appointment_datetime DATETIME NOT NULL, duration_mins INT NOT NULL, appointment_title VARCHAR(100) DEFAULT NULL, appointment_desc LONGTEXT DEFAULT NULL, appointment_type VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
